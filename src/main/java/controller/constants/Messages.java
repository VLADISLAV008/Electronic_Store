...
public final class Messages {
    ...
    public static final String ERR_CANNOT_SELECT_ORDER = "Sorry, an error occurred while selecting your order.";
    ...
    public static final String ERR_FAILED_SELECT_ORDERED_PRODUCTS = "Failed to select ordered products.";
}